...
async function GAMES202Main() {
	...
	let boxTransform = setTransform(0, 0, 0, 120, 120, 120);
	...
	//打印precomputeLT和precomputeL的shape
	console.log(precomputeLT);
	console.log(precomputeL);
	console.log("indirect light:", indirectLight);

	//debug area
	//=============================
	console.log("==============================");
	computeSquareMatrix_3by3(mat4.create());
	computeSquareMatrix_5by5(mat4.create());
	console.log("==============================");
